...
public final class Temperatur implements Comparable<Temperatur> {
    ...
    /**
     * Sets the temperature value in celsius with a Scanner.
     *
     *
     *
     */
    /*
    public final void setTempCWithScanner() {
        String input;
        ...
        do {
            ...
            input = scanner.next();
            if(input.matches("-?\\d+")){
                this.tempCelsius = Double.parseDouble(input);
                System.out.println("New Temperatur: " + input + "°C");
                System.out.println(this.tempCelsius);
            } else {
