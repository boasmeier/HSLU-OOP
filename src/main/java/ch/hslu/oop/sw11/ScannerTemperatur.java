...
public class ScannerTemperatur {
     ...
     * @return
     */
    public static final double setTempCWithScanner(TemperaturVerlauf verlauf, Set<Temperatur> temperaturen) {
        String input;
        double value = 0;
    ...
    public static void addTemperaturToSet(TemperaturVerlauf verlauf, Set<Temperatur> temperaturen, double temperaturCelsius) {
