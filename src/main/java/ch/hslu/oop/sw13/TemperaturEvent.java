...
public class TemperaturEvent extends EventObject {
    ...
    private static final Logger LOG = LogManager.getLogger(TemperaturEvent.class);
    ...
    public TemperaturEvent(Object source, String propertyName, double oldValue, double newValue) {
        super(source);
